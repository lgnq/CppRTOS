                    ...
                    rt_uint8_t   flag)
{
    ...
    /* init mailbox */
    mb->msg_pool   = (rt_uint32_t *)msgpool;
    mb->size       = size;
    mb->entry      = 0;
    mb->in_offset  = 0;
    mb->out_offset = 0;
...
rt_mailbox_t rt_mb_create(const char *name, rt_size_t size, rt_uint8_t flag)
{
    ...
    /* init mailbox */
    mb->size     = size;
    mb->msg_pool = (rt_uint32_t *)RT_KERNEL_MALLOC(mb->size * sizeof(rt_uint32_t));
                    ...
                    rt_uint8_t  flag)
{
    ...
    for (temp = 0; temp < mq->max_msgs; temp ++)
    {
        ...
        head->next = (rt_mq_message *)mq->msg_queue_free;
...
rt_err_t rt_mq_urgent(rt_mq_t mq, void *buffer, rt_size_t size)
{
    ...
    msg->next = (rt_mq_message *)mq->msg_queue_head;
    mq->msg_queue_head = msg;
